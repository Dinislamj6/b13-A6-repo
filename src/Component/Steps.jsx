            ...
            <div className='grid p-5 gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                ...
                <div className="card bg-base-100 shadow-sm">
                    <div className="card-body">
                      ...
                      <div className='flex justify-center'>
                          <img className='bg-blue-100 rounded-full p-2 object-contain' src={userImg} alt="userImg" />
                      </div>
                ...
                <div className="card bg-base-100 shadow-sm">
                    <div className="card-body">
                      ...
                      <div className='flex justify-center'>
                          <img className='bg-blue-100 rounded-full p-2 object-contain' src={packageImg} alt="packageImg" />
                      </div>
                      <div className='text-center space-y-2 p-3'>
                ...
                <div className="card bg-base-100 shadow-sm">
                    <div className="card-body">
                      ...
                      <div className='flex justify-center'>
                          <img className='bg-blue-100 rounded-full p-2 object-contain' src={rocketImg} alt="rocketImg" />
                      </div>
                      <div className='text-center space-y-2 p-3'>
